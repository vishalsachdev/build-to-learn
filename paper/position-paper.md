...
**Then the language caught up.** Three Substack pieces document the gestation — building IS the medium of learning ([*Simulating to learn*, May 2023](https://chatwithgpt.substack.com/p/simulating-to-learn)); building fluency is no longer specialist ([*We are all app developers now*, July 2024](https://chatwithgpt.substack.com/p/we-are-all-app-developers-now)); cheap leverage unlocks a new category of use cases ([*If Intelligence is too cheap to meter*, July 2024](https://chatwithgpt.substack.com/p/if-intelligence-is-too-cheap-to-meter)). Plus a piece on what replaces ghostwriting-vulnerable assessment ([*What to do after you destroy your assessments*, September 2023](https://chatwithgpt.substack.com/p/what-to-do-after-you-destroy-your)) — the objection §4.1 would later have to defend, answered 17 months early. None of these used the couplet. All of them were heading toward it.
