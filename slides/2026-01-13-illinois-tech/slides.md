...
<ul class="text-lg space-y-3">
  ...
  <li>🏫 <strong>Policy:</strong> follow Illinois Tech guidance for AI / privacy / security before production use.</li>
</ul>
...
💡 <strong>Or...</strong> solve a real challenge from your course!<br/>
