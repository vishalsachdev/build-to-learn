...
<div class="text-sm opacity-70">Drag & drop — live in seconds</div>
</div>
...
<div class="text-sm opacity-70">Free forever — great for portfolios</div>
</div>
...
<div><strong>Google AI Studio</strong> — sketch-to-code, free <span class="opacity-60">(used today)</span></div>
<div><strong>ChatGPT Canvas</strong> — chatgpt.com — live HTML preview + download</div>
<div><strong>Claude Artifacts</strong> — claude.ai — generates interactive previews</div>
<div><strong>Gemini Canvas</strong> — gemini.google.com — code preview + export</div>
</div>
</div>
...
<div class="space-y-1 text-sm">
<div><strong>Netlify Drop</strong> — app.netlify.com/drop — drag & drop, instant</div>
<div><strong>GitHub Pages</strong> — pages.github.com — permanent, free forever</div>
<div><strong>CodePen</strong> — codepen.io — paste code, instant preview + URL</div>
<div><strong>Replit</strong> — replit.com — browser IDE + free static hosting</div>
</div>
</div>
...
<div class="space-y-1 text-sm">
<div><strong>Lovable</strong> — lovable.dev — most beginner-friendly app builder</div>
<div><strong>Bolt.new</strong> — bolt.new — describe an app, get a preview</div>
<div><strong>Replit Agent</strong> — replit.com — AI builds full apps for you</div>
<div><strong>v0.dev</strong> — v0.dev — Vercel's AI UI generator</div>
</div>
</div>
...
<div class="space-y-1 text-sm">
<div><strong>Excalidraw</strong> — excalidraw.com — whiteboard for wireframes</div>
<div><strong>tldraw</strong> — tldraw.com — similar whiteboard, Make Real feature</div>
<div><strong>Napkin AI</strong> — napkin.ai — turn text into visuals</div>
<div><strong>Google Stitch</strong> — stitch.withgoogle.com — sketch-to-UI (experimental)</div>
</div>
</div>
